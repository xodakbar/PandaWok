      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden relative">
        ...
        {!isReservationDetailsOpen ? (
          <div className="flex-1 bg-slate-100 flex flex-col timeline-container">
              ...
              <div className="md:hidden flex items-center p-2 bg-white salon-selector-container gap-2">
                <select 
                  value={activeTab}
                  onChange={(e) => setActiveTab(e.target.value)}
                  className="flex-1 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-700"
                >
